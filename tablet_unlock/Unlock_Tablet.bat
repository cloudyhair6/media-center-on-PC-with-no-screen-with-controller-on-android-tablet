@echo off
echo [Media Centre] Please connect your tablet via USB
pause
echo [Media Centre] Unlocking Tablet...
cd /d "%~dp0"
echo Method 1: ADB Force Unlock...
platform-tools\adb.exe shell am start -n com.minipc.unlock/.UnlockActivity >nul 2>&1
