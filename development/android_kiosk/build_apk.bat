...
if not exist my-release-key.keystore "%JAVA_HOME%\bin\keytool.exe" -genkey -v -keystore my-release-key.keystore -alias mykey -keyalg RSA -keysize 2048 -validity 10000 -storepass password -keypass password -dname "CN=Media Centre, O=Media Centre, C=US"
...
echo [7] Copying APK to tablet_apk directory...
copy /Y app.apk "..\..\tablet_apk\app.apk"
